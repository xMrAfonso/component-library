        ...
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-2">
            ...
            <button
              ...
              className="ml-3 px-4 py-2 rounded-lg bg-gradient-to-r from-blue-500 to-violet-500 text-white hover:from-violet-500 hover:to-blue-500 transition"
            >
          ...
          <div className="flex items-center space-x-2 md:hidden">
            <button
              onClick={() => setDarkMode(!darkMode)}
              aria-label="Toggle theme"
              className="px-3 py-1 rounded-lg bg-gradient-to-r from-blue-500 to-violet-500 text-white hover:from-violet-500 hover:to-blue-500 transition"
            >
              {darkMode ? "Light" : "Dark"}
            </button>
            <button
